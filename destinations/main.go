...
import (
	...
	"github.com/kv4sha/golang-mongodb-docker/destinations/config"
	"github.com/kv4sha/golang-mongodb-docker/destinations/middlewares"
	"github.com/kv4sha/golang-mongodb-docker/destinations/router"
)
